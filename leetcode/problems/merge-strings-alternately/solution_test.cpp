...
TEST_F(MergeStringsTest, Example1) {
  EXPECT_EQ(BruteForce().mergeAlternately("abc", "pqr"), "apbqcr");
}

TEST_F(MergeStringsTest, Example2) {
  EXPECT_EQ(BruteForce().mergeAlternately("ab", "pqrs"), "apbqrs");
}

TEST_F(MergeStringsTest, Example3) {
  EXPECT_EQ(BruteForce().mergeAlternately("abcd", "pq"), "apbqcd");
}
